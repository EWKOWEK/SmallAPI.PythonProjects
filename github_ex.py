...
while True:
    ...
    if previousData != currentData:
        ...
        print(f"Username: {currentData.get('login')}, Name: {currentData.get('name')}, Followers: {currentData.get('followers')}, Following: {currentData.get('following')}, Bio: {currentData.get('bio', 'N/A')}")
    else:
        pass
